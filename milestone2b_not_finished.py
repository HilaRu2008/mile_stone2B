...
def main():
    ...
    print("\n============== all log file info ============ \n")
    print(list_of_all_info_log(log_file_path))

    # the relevant info from the log file
    print("\n================ log file relevant info ============== \n")
    print(relevant_info_log_file(log_file_path))
    ...
    # the sus processes
    log_list_info_relevant = relevant_info_log_file(log_file_path)  # the relevant info from log file
    ...
    list_of_all_info_in_log_file = list_of_all_info_log(log_file_path)  # the list of all info from the log file
